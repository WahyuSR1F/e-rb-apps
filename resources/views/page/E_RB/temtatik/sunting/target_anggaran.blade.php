...
@section('viewer')
    <div class="mt-[3.5rem]">
        <div class="relative w-full overflow-x-auto shadow-md sm:rounded-lg">
            <div class="w-full">
                ...
                <h1 class="text-xl font-bold">Target Anggaran</h1>
            ...
            <div class="flex justify-end mt-6 mb-2">
                <a href="{{ route('target-penyelesaian') }}">
                    <button class="p-1 py-2 mx-1 text-sm bg-green-400 text-white font-semibold hover:bg-green-700 rounded-lg">Target
                        Penyelesaian</button>
                </a>
                <button id="createButton" data-modal-target="create-modal" data-modal-toggle="create-modal"
                    class="p-1 bg-blue-400 text-white font-semibold text-sm hover:bg-blue-700 rounded-lg"><span><i
                            class="fa-solid fa-plus text-white text-sm  mx-1"></i></span>Create Target Anggaran</button>
            </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    <form action="{{ route('target-anggaran-delete') }}" method="post">
                        @csrf
    ...
    <div id="crudModal1" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ route('target-anggaran-edit') }}" method="post" class="p-4 md:p-5">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <h6 class="font-bold text-white text-xs">Edit Target Anggaran</h6>
                        <input type="hidden" name="id" id="idTargetPenyelesaian">
    ...
    <div id="create-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form action="{{ route('target-anggaran-create') }}" method="post" class="p-4 md:p-5">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
    ...
    <script src="{{ asset('assets/js/targetAnggaran.js') }}"></script>
@endsection
