    ...
    <div class="mt-[5rem]">
        ...
        <main class="container mx-auto mt-8 bg-gray-100 p-8 rounded-lg shadow-lg ">
            ...
            <div class="flex gap-6 mb-6">
                <div class="w-1/4">
                    <div
                        class="max-w-sm p-6 bg-blue-400 border border-gray-200">
                        <div class="flex gap-6 justify-start">
                            <svg class=" w-7 h-7 text-white mb-3" aria-hidden="true"
                ...
                <div class="w-1/4">
                    <div
                        class="max-w-sm p-6  bg-yellow-400 border border-gray-200 rounded-lg shadow ">
                        <div class="flex gap-6 justify-start">
                            <svg class=" w-7 h-7 text-white mb-3" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path
                ...
                <div class="w-1/4">
                    <div
                        class="max-w-sm p-6 bg-green-400 border border-gray-200 rounded-lg shadow ">
                        <div class="flex gap-6 justify-start">
                ...
                <div class="w-1/4">
                    <div
                        class="max-w-sm p-6 bg-orange-400 border border-gray-200 rounded-lg shadow">
                        <div class="flex gap-6 justify-start">
                            <svg class=" w-7 h-7 text-white mb-3" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path
